...
public class SecurityConfig {
    ...
    public UserDetailsService userDetailsService() {
                return userService; // Dùng đúng bean UserService đã được Spring quản lý.
    }
    ...
    public SecurityFilterChain securityFilterChain(@NotNull HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/cart", "/cart/**", "/order", "/order/**")
                        .hasAnyAuthority("USER", "ADMIN") // MANAGER không được mua hàng.
                        .requestMatchers("/loyalty/**")
                        .hasAuthority("USER") // Trang đổi điểm chỉ dành cho USER.
                        .requestMatchers("/products/add", "/products/edit/**", "/products/update/**", "/products/delete/**")
                        .hasAnyAuthority("ADMIN", "MANAGER") // ADMIN và MANAGER được CRUD sản phẩm.
                        .requestMatchers("/categories/**")
                        .hasAuthority("ADMIN") // Quản lý danh mục chỉ dành cho ADMIN.
                        .requestMatchers("/api/**")
